...
export const metadata: Metadata = {
  title: "New Album Release - Listen Now",
  description: "Discover our latest album. Premium quality music with 12 tracks spanning 45 minutes. Stream on all major platforms.",
  keywords: ["music album", "new release", "streaming", "artist"],
  openGraph: {
    title: "New Album Release - Listen Now",
    description: "Discover our latest album. Premium quality music with 12 tracks spanning 45 minutes. Stream on all major platforms.",
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1764762203837-1l2uco5f.jpg",
        alt: "Album artwork"
      }
    ]
  },
  twitter: {
    ...
    title: "New Album Release - Listen Now",
    description: "Discover our latest album. Stream on all major platforms.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1764762203837-1l2uco5f.jpg"]
  }
};
